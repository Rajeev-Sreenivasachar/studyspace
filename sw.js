const CACHE = "studyspace-shell-v19";
const CORE = [
  "./", "index.html", "offline.html", "styles.css", "app.js?v=15", "manifest.webmanifest",
  "assets/favicon.svg", "assets/chatbot.css?v=1", "assets/chatbot.js?v=2", "assets/studyspace-core.js",
  "assets/data/course-frameworks.js?v=3", "assets/data/middleton-course-library.js?v=2", "assets/data/full-course-content.js?v=4", "assets/course-framework-ui.js?v=4", "assets/course-runtime.js?v=4", "assets/course-library.js?v=4", "styles.css?v=13",
